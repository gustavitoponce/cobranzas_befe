...
import { DocumentacionRequerida } from '../entidades/documentacion-requerida.entity';
import { DocumentacionRequeridaDto } from '../dto/documentacion-requerida.dto';
...
export declare class DocumentacionRequeridaService {
    ...
    getByCode(codigo: string): Promise<DocumentacionRequerida>;
    ...
    search(term: string, incluirInactivos: string): Promise<DocumentacionRequerida[]>;
}
