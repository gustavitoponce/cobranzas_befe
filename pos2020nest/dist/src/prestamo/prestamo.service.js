...
let PrestamoService = class PrestamoService {
    ...
    async update(id, prestamo) {
        ...
        console.log('llego al puto servicio con id ===>',id);
        
        prestamoActualizar.estado=prestamo.estado;
        console.log(prestamo.estado);
        prestamoActualizar.observacion = prestamoActualizar.observacion +"\n" + " viva Peron y EVITA y Kristina";
        console.log(prestamoActualizar);
