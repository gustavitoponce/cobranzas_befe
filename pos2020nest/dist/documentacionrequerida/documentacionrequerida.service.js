...
const documentacion_requerida_entity_1 = require("../entidades/documentacion-requerida.entity");
...
let DocumentacionRequeridaService = class DocumentacionRequeridaService {
    ...
    async create(documentacionrequerida) {
        return new Promise(async (resolve, reject) => {
            ...
            try {
                const nuevoDocumentacionRequerida = new documentacion_requerida_entity_1.DocumentacionRequerida();
...
DocumentacionRequeridaService = __decorate([
    common_1.Injectable(),
    __param(0, typeorm_2.InjectRepository(documentacion_requerida_entity_1.DocumentacionRequerida)),
