...
let PrestamoController = class PrestamoController {
        ...
        this.prestamoService
            ...
            if (prestamos.length > 0) {
                response
                    ...
                    .json(new cresponse_1.CResponse(1, 'Exito', null, prestamos));
            }
            else {
                response
                    .status(common_1.HttpStatus.OK)
    ...
    create(prestamoDto, response) {
        this.prestamoService
            ...
            response
                .status(common_1.HttpStatus.OK)
                .json(new cresponse_1.CResponse(1, 'Zona creada correctamente', null, prestamo));
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], PrestamoController.prototype, "getDetail", null);
__decorate([
    common_1.Get(':id'),
    __param(0, common_1.Res()), __param(1, common_1.Param('id')),
    __metadata("design:type", Function),
